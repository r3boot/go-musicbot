...
RADIO_2600NL_OGG_LISTENERS=$(grep '/2600nl.ogg' ${PLAYLIST_LOG} | tail -1 | cut -d\| -f3)
RADIO_2600NL_MP3_LISTENERS=$(grep '/2600nl.mp3' ${PLAYLIST_LOG} | tail -1 | cut -d\| -f3)
RADIO_2600NL_LISTENERS=$(expr ${RADIO_2600NL_OGG_LISTENERS} + ${RADIO_2600NL_MP3_LISTENERS})
RADIO_2600NL_NOWPLAYING="$(grep '/2600nl.mp3' ${PLAYLIST_LOG} | tail -1 | cut -d\| -f4)"
